...
public class CanvasActivity extends AppCompatActivity implements View.OnSystemUiVisibilityChangeListener, SharedPreferences.OnSharedPreferenceChangeListener {
	...
	final Uri homepageUri = Uri.parse("https://github.com/abdalmoniem/GfxTablet");
	...
	public void showAbout(MenuItem item) {
		new AlertDialog.Builder(this)
				.setMessage("Designed by AbdAlMoniem AlHifnawy, tap OK to go to github repo.")
				.setTitle("GfxTablet About")
		...
		protected void onPostExecute(Boolean success) {
			if (success) {
				Toast.makeText(CanvasActivity.this,
						"Touch events will be sent to " + netClient.destAddress.getHostAddress() + ":" + NetworkClient.GFXTABLET_PORT, Toast.LENGTH_SHORT).show();
			}
